...
def get_cp(self, attr, attr_type, class_value):
  ...
  '''
  Here we calculate Likelihood of Evidence and multiple all
  individual probabilities with priori
...
if __name__ == "__main__":
  ...
  outlook = input("What's the weather outside? (Sunny, Rainy,
  Overcast):")
  if outlook.lower() == 'x' or outlook.lower() == 'exit':
  exitSystem()
  temp = input("What's the temperature today? (Hot, Mild, Cool):")
  if temp.lower() == 'x' or temp.lower()== 'exit':
  exitSystem()
  humidity = input("What's the humidity? (High, Normal):")
  ...
  c.hypothesis = {"Outlook":outlook, "Temp":temp, "Humidity":humidity ,
  "Windy":windy}
  c.calculate_priori()
